...
# python main.py --which_splits 5foldcv --dataset tcga_skcm --data_root_dir "D:\Documents\Pycharm\MIL\PORPOISE\datasets\TCGA-SKCM\TCGA-SKCM-pt_files" --modal coattn --model cmta --num_epoch 10 --batch_size 1 --loss nll_surv_l1 --lr 0.001 --optimizer SGD --scheduler None --alpha 1.0

#python main.py --which_splits 5foldcv --dataset tcga_lusc --data_root_dir "D:\Documents\Pycharm\MIL\PORPOISE\datasets\TCGA-LUSC\TCGA-LUSC-pt_files" --modal coattn --model cmta --num_epoch 10 --batch_size 1 --loss nll_surv_l1 --lr 0.001 --optimizer SGD --scheduler None --alpha 1.0